class ProductLocators:
    ...
    PRODUCT_PAGE_TITLE = '//android.view.ViewGroup[@index="0"]/android.widget.TextView[@index="1"]'
    PRODUCT_BACK_BUTTON = '//android.view.ViewGroup[@index="0"]/android.widget.ImageButton[@index="0"]'
    PRODUCT_ADD_TO_SHOPPING_LIST = '//android.widget.TextView[@text="В список покупок"]'
